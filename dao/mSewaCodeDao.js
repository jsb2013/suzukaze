...
/* 檀家追加画面でtiku&sewaninボックスの表示の利用（get処理） */
exports.getMSewaCodeForSewaNameBySewaCode = function(client, database, rows, sewaCode, dbcallback){
    var isDbError = false;
    var query = client.query('select sewa_name from m_sewa_code where sewa_code = $1 and is_disabled=false and is_deleted=false',
                [sewaCode]);
