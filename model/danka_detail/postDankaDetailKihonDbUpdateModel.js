...
function insertTDanka(memberId, webItemJson, dbcallback){
    ...
    var query = client.query('INSERT INTO t_danka(member_id, danka_type, member_id_kosyu, member_id_sewa, member_id_sou, yobi_1, yobi_2, create_user, create_date, update_user, update_date, is_deleted) VALUES ($1,$2,$3,$4,$5,null,null,$6,now(),$7,now(),FALSE)',
