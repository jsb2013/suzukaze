...
exports.main = function (searchId, callback) {
    ...
    // 【END】トランザクション完了(commit or rollback)
        function (err, results) {
            ...
            callback(false, resultRows, tikuInfoJson, tikuList, searchMoji);
            return;
        }
    );
};
